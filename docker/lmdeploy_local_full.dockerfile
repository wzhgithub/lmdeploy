FROM ncr.nioint.com/docker.io/nvidia/cuda:12.2.2-devel-ubuntu22.04 AS cu12
...
RUN --mount=type=cache,target=/root/.cache/pip \
    python3 -m pip install --upgrade pip setuptools==69.5.1 -i https://mirrors.cloud.tencent.com/pypi/simple &&\
    ...
    python3 -m pip install cmake packaging wheel -i https://mirrors.cloud.tencent.com/pypi/simple
